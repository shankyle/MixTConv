...
def get_augmentation(input_size, modality, flip=True):
    if modality == 'RGB':
        if flip:
...
if __name__ == '__main__':
    num_class, train_list, val_list, root_path, prefix = dataset_config.return_dataset('somethingv1', 'RGB')
    print(num_class, train_list, val_list, root_path, prefix)
    crop_size = 224
    scale_size = crop_size * 256 // 224
    train_augmentation = get_augmentation(crop_size, 'RGB', flip=False)
