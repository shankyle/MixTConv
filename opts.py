...
import argparse
parser = argparse.ArgumentParser(description="PyTorch implementation of CFM")
...
parser.add_argument('--n_div', default=8, type=int, help='number of div for operations (default: 8)')
parser.add_argument('--operations', default='baseline', type=str, help='operations for backbone(default:baseline)')

parser.add_argument('--non_local', default=False, action="store_true", help='add non local block')
parser.add_argument('--dwise', default=False, action="store_true", help='add depth wise correlation blocks')
